...
func (ec *executionContext) field_Mutation_createJobListing_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCreateJobListingInput2githubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐCreateJobListingInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateJobListing_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNUpdateJobListingInput2githubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐUpdateJobListingInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNJobListing2ᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐJobListing(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_deleteJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDeleteJobResponse2ᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐDeleteJobResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_jobs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.JobListing)
	fc.Result = res
	return ec.marshalNJobListing2ᚕᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐJobListingᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateJobListingInput2githubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐCreateJobListingInput(ctx context.Context, v any) (model.CreateJobListingInput, error) {
	res, err := ec.unmarshalInputCreateJobListingInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDeleteJobResponse2githubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v model.DeleteJobResponse) graphql.Marshaler {
	return ec._DeleteJobResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNDeleteJobResponse2ᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteJobResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNJobListing2githubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v model.JobListing) graphql.Marshaler {
	return ec._JobListing(ctx, sel, &v)
}

func (ec *executionContext) marshalNJobListing2ᚕᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐJobListingᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.JobListing) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNJobListing2ᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐJobListing(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNJobListing2ᚖgithubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v *model.JobListing) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateJobListingInput2githubᚗcomᚋgajareᚋgqrᚑytᚋgraphᚋmodelᚐUpdateJobListingInput(ctx context.Context, v any) (model.UpdateJobListingInput, error) {
